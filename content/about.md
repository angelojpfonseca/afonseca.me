...
My formal training is a Diplom-Ingenieur in mechanical engineering from Centro Universitário do Distrito Federal in Brasília, with a two-year exchange at the Technische Universität Berlin under the *Ciência sem Fronteiras* programme.

Working languages: Portuguese (native), German (fluent), English (fluent). Working tools, roughly in order of how often I reach for them: Python, SQL, Power BI, Pandas, Linux, Docker, AWS / GCP, and a growing list of LLM tooling (OpenAI, Anthropic, Gemini, Ollama, LangChain, Autogen, CrewAI).
